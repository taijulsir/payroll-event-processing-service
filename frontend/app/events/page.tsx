...
export default function EventsWorkspacePage() {
  ...
  // Polling every 5 seconds for live event updates
  ...
  // Active in-flight count on the current page slice
    ...
    <>
      ...
      <div className="kpi-grid">
        <div className="kpi-card">
          <span className="kpi-card__label">Total Filtered</span>
          <span className="kpi-card__value mono">{total}</span>
          <span className="kpi-card__sub">
            {hasActiveFilters ? 'Matching current criteria' : 'Total events recorded in database'}
          </span>
        </div>
        <div className="kpi-card">
          <span className="kpi-card__label">Active On Page</span>
          <span
          ...
          <span className="kpi-card__sub">Pending queue or worker processing</span>
        </div>
        <div className="kpi-card">
          <span className="kpi-card__label">Feed Polling</span>
          <span className="kpi-card__value" style={{ fontSize: '0.95rem', fontWeight: 600 }}>
            {lastLoadedAt ? `Updated ${formatRelative(lastLoadedAt)}` : 'Live'}
          </span>
          <span className="kpi-card__sub">Auto-polled every 5 seconds</span>
        </div>
      </div>
          ...
          <div className="filter-group">
            <div className="filter-input-wrap">
              ...
              <input
                ...
                placeholder="Search Employee ID (e.g. emp-1001)"
